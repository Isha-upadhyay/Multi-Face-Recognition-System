...
from parameters import LOG_FILE_PATH #path to the log file
from util.generic_utilities import check_for_directory #function to check if a directory exists and create it if it does not
